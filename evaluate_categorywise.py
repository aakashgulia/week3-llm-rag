...
if len(sys.argv) != 2:
    print("Usage: python3 evaluate_categorywise.py <model>")
    sys.exit(1)

model = sys.argv[1]

with open("evaluation_questions_categorywise.json", "r") as f:
    questions = json.load(f)

with open("evaluation_reference_categorywise.json", "r") as f:
